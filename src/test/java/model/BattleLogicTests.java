...
public class BattleLogicTests {
    ...
    public void testCharacterAttackSuccess() {
        ...
        BattleLogic.AttackResult result = BattleLogic.characterAttack(character, enemy, roll);
    ...
    public void testEnemyAttackSuccess() {
        ...
        BattleLogic.AttackResult result = BattleLogic.enemyAttack(enemy, character, roll);
